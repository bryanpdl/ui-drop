  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-[#1F1F1F] p-8 rounded-lg w-full max-w-md">
        ...
        <div className="mt-4">
          <button onClick={handleGoogleSignIn} className="w-full bg-white text-gray-800 font-bold py-2 px-4 rounded-full hover:bg-gray-200 transition-colors duration-300 flex items-center justify-center">
        ...
        <p className="mt-4 text-center text-sm text-gray-400">
          ...
          <button onClick={onSignUpClick} className="text-button-hover hover:underline">Sign up</button>
        </p>
      </div>
    </div>
  );
